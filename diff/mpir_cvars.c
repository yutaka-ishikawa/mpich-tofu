 ...
 *   at:   Sun Oct 11 10:58:47 2020 UTC
 *
 * DO NOT EDIT!!!
 */
...
int MPIR_CVAR_CH4_OFI_SHORT_SEND_SIZE;	// YI
...
int MPIR_T_cvar_init(void)
{
    ...
    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpi/coll/alltoall/alltoall.c */
    MPIR_T_cat_add_desc("COLLECTIVE",
        "A category for collective communication variables.");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpi/comm/comm_split.c */
    MPIR_T_cat_add_desc("COMMUNICATOR",
        "cvars that control communicator construction and operation");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpi/datatype/typerep/dataloop/segment.c */
    MPIR_T_cat_add_desc("DATALOOP",
        "Dataloop-related CVARs");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpi/errhan/errutil.c */
    MPIR_T_cat_add_desc("ERROR_HANDLING",
        "cvars that control error handling behavior (stack traces, aborts, etc)");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpi/init/init.c */
    MPIR_T_cat_add_desc("THREADS",
        "multi-threading cvars");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpi/init/initthread.c */
    MPIR_T_cat_add_desc("DEBUGGER",
        "cvars relevant to the \"MPIR\" debugger interface");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpi/init/mpi_init.h */
    MPIR_T_cat_add_desc("DEVELOPER",
        "useful for developers working on MPICH itself");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpi/topo/dims_create.c */
    MPIR_T_cat_add_desc("DIMS",
        "Dims_create cvars");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/nameserv/file/file_nameserv.c */
    MPIR_T_cat_add_desc("PROCESS_MANAGER",
        "cvars that control the client-side process manager code");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/util/mpir_handlemem.c */
    MPIR_T_cat_add_desc("MEMORY",
        "affects memory allocation and usage, including MPI object handles");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/util/mpir_nodemap.h */
    MPIR_T_cat_add_desc("NODEMAP",
        "cvars that control behavior of nodemap");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/include/mpir_gpu.h */
    MPIR_T_cat_add_desc("GPU",
        "GPU related cvars");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/include/mpir_request.h */
    MPIR_T_cat_add_desc("REQUEST",
        "A category for requests mangement variables");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_init.c */
    MPIR_T_cat_add_desc("NEMESIS",
        "cvars that control behavior of the ch3:nemesis channel");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_lmt.c */
    MPIR_T_cat_add_desc("FT",
        "cvars that control behavior of fault tolerance");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpid/ch3/src/mpidi_rma.c */
    MPIR_T_cat_add_desc("CH3",
        "cvars that control behavior of ch3");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpid/ch4/netmod/ofi/ofi_init.c */
    MPIR_T_cat_add_desc("CH4_OFI",
        "A category for CH4 OFI netmod variables");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpid/ch4/netmod/ucx/ucx_init.c */
    MPIR_T_cat_add_desc("CH4_UCX",
        "A category for CH4 UCX netmod variables");

    /* declared in /home/users/ea01/ea0103/work/mpich-latest/mpich/maint/../src/mpid/ch4/src/ch4_init.c */
...
silent  - silently fallback to the internally selected algorithm");
    ...
    // printf("YI**** MPIR_CVAR_CH4_OFI_ENABLE_MR_VIRT_ADDRESS=%d\n", MPIR_CVAR_CH4_OFI_ENABLE_MR_VIRT_ADDRESS);
