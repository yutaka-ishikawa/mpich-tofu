#!/bin/bash
#------ pjsub option --------#
#PJM -N "IMB-MPICH-IMB1"
#PJM -S
#PJM --spath "results/mpich-org/imb/imb1/%n.%j.stat"
#PJM -o "results/mpich-org/imb/imb1/%n.%j.out"
#PJM -e "results/mpich-org/imb/imb1/%n.%j.err"
#	#PJM -L "node=4"
#	PJM -L "node=8"
#PJM -L "node=16"
#PJM -g "pz0485"
...
MPIOPT="-of results/mpich-org/imb/imb1/%n.%j.out -oferr results/mpich-org/imb/imb1/%n.%j.err"
...
BENCH="Sendrecv Exchange Allreduce Reduce Reduce_scatter Allgather Gather Scatter Alltoall"
LENFILE=len-imb1.txt
MEM=3	# in GB
##MSGLOG="0:31"
MSGLOG="0:30"
NPMIN=64
