#!/bin/bash
#------ pjsub option --------#
#PJM -N "IMB-MPICH-EXCH"
#PJM -S
#PJM --spath "results/mpich-org/imb/exch/%n.%j.stat"
#PJM -o "results/mpich-org/imb/exch/%n.%j.out"
#PJM -e "results/mpich-org/imb/exch/%n.%j.err"
#	#PJM -L "node=4"
#	PJM -L "node=8"
#PJM -L "node=16"
#PJM -g "pz0485"
...
MPIOPT="-of results/mpich-org/imb/exch/%n.%j.out -oferr results/mpich-org/imb/exch/%n.%j.err"
