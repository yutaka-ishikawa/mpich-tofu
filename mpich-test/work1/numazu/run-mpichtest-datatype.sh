...
echo -e "[TESTNAME]: getpartelm\n[OUTPUT]:" | tee -a /dev/stderr
mpiexec -n 2    /home/users/ea01/ea0103/work/mpich-tofu/mpich/test/mpi/datatype/getpartelm 
echo -e "[RETURN-VAL]: $?\n"

echo -e "[TESTNAME]: tresized\n[OUTPUT]:" | tee -a /dev/stderr
mpiexec -n 2    /home/users/ea01/ea0103/work/mpich-tofu/mpich/test/mpi/datatype/tresized 
echo -e "[RETURN-VAL]: $?\n"

echo -e "[TESTNAME]: tresized2\n[OUTPUT]:" | tee -a /dev/stderr
mpiexec -n 2    /home/users/ea01/ea0103/work/mpich-tofu/mpich/test/mpi/datatype/tresized2 
echo -e "[RETURN-VAL]: $?\n"
