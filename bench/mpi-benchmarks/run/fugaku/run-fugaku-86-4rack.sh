#!/bin/bash
#------ pjsub option --------#
#PJM -N "MPICH-IMB-86-4rack" # jobname
#PJM -S
#PJM --spath "results/IMB-86rack/%n.%j.stat"
#PJM -o "results/IMB-86rack/%n.%j.out"
#PJM -e "results/IMB-86rack/%n.%j.err"
#
#PJM -L "node=132096"
#	This is 86 (4ppn) rack
...
MPIOPT="-of results/IMB-86rack/%n.%j.out -oferr results/IMB-86rack/%n.%j.err"
