#!/bin/bash
#------ pjsub option --------#
#PJM -N "MPICH-IMB-36rack" # jobname
#PJM -S
#PJM --spath "results/IMB-36rack/%n.%j.stat"
#PJM -o "results/IMB-36rack/%n.%j.out"
#PJM -e "results/IMB-36rack/%n.%j.err"
#
#	PJM -L "node=32"
#	PJM -L "node=64"
#	PJM -L "node=128"
...
MPIOPT="-of results/IMB-36rack/%n.%j.out -oferr results/IMB-36rack/%n.%j.err"
...
OKBENCH="Alltoall" # OK, step3-4=3.004016sec, elapse=02:19
