#!/bin/bash
#------ pjsub option --------#
#PJM -N "MPICH-IMB-24-4-1rack" # jobname
#PJM -S
#PJM --spath "results/IMB-24rack/%n.%j.stat"
#PJM -o "results/IMB-24rack/%n.%j.out"
#PJM -e "results/IMB-24rack/%n.%j.err"
#
#	PJM -L "node=32"
#	PJM -L "node=64"
#	PJM -L "node=128"
...
MPIOPT="-of results/IMB-24rack/%n.%j.out -oferr results/IMB-24rack/%n.%j.err"
...
##OKBENCH="Alltoall" # OK, step3-4=25.240202sec, elapse=03:50

NP=36864
mpich_exec $MPIOPT ../../IMB-MPI1 -mem 5 -npmin $NP -msglen len5.txt $OKBENCH #
exit
#
