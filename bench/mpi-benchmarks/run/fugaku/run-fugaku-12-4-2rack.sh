#!/bin/bash
#------ pjsub option --------#
#PJM -N "MPICH-IMB-12-4-2rack" # jobname
#PJM -S
...
#OKBENCH="Alltoall" # OK, step3-4=29.637201sec, elapse=04:15

NP=18432
mpich_exec $MPIOPT ../../IMB-MPI1 -mem 7 -npmin $NP -msglen len5.txt $OKBENCH #
exit
#
