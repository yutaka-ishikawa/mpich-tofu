#!/bin/bash
#------ pjsub option --------#
#PJM -N "IMB-SMALL-AGGTAGGED" # jobname
#PJM -S
#PJM --spath "results/IMB-small-agg/%n.%j.stat"
#PJM -o "results/IMB-small-agg/%n.%j.out"
#PJM -e "results/IMB-small-agg/%n.%j.err"
#
#	PJM -L "node=32"
#PJM -L "node=64"
#	PJM -L "node=128"
...
MPIOPT="-of results/IMB-small-agg/%n.%j.out -oferr results/IMB-small-agg/%n.%j.err"
