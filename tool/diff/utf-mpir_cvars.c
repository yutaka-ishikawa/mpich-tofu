 ...
 *   at:   Wed Dec 23 22:02:56 2020 UTC
 *
 * DO NOT EDIT!!!
 */
...
int MPIR_CVAR_CH4_OFI_SHORT_SEND_SIZE;	// TOFU
...
int MPIR_T_cvar_init(void)
{
    ...
    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpi/coll/alltoall/alltoall.c */
    MPIR_T_cat_add_desc("COLLECTIVE",
        "A category for collective communication variables.");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpi/comm/comm_split.c */
    MPIR_T_cat_add_desc("COMMUNICATOR",
        "cvars that control communicator construction and operation");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpi/datatype/typerep/dataloop/segment.c */
    MPIR_T_cat_add_desc("DATALOOP",
        "Dataloop-related CVARs");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpi/errhan/errutil.c */
    MPIR_T_cat_add_desc("ERROR_HANDLING",
        "cvars that control error handling behavior (stack traces, aborts, etc)");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpi/init/init.c */
    MPIR_T_cat_add_desc("THREADS",
        "multi-threading cvars");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpi/init/initthread.c */
    MPIR_T_cat_add_desc("DEBUGGER",
        "cvars relevant to the \"MPIR\" debugger interface");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpi/init/mpi_init.h */
    MPIR_T_cat_add_desc("DEVELOPER",
        "useful for developers working on MPICH itself");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpi/topo/dims_create.c */
    MPIR_T_cat_add_desc("DIMS",
        "Dims_create cvars");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/nameserv/file/file_nameserv.c */
    MPIR_T_cat_add_desc("PROCESS_MANAGER",
        "cvars that control the client-side process manager code");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/util/mpir_handlemem.c */
    MPIR_T_cat_add_desc("MEMORY",
        "affects memory allocation and usage, including MPI object handles");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/util/mpir_nodemap.h */
    MPIR_T_cat_add_desc("NODEMAP",
        "cvars that control behavior of nodemap");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/include/mpir_gpu.h */
    MPIR_T_cat_add_desc("GPU",
        "GPU related cvars");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/include/mpir_request.h */
    MPIR_T_cat_add_desc("REQUEST",
        "A category for requests mangement variables");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_init.c */
    MPIR_T_cat_add_desc("NEMESIS",
        "cvars that control behavior of the ch3:nemesis channel");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_lmt.c */
    MPIR_T_cat_add_desc("FT",
        "cvars that control behavior of fault tolerance");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpid/ch3/src/mpidi_rma.c */
    MPIR_T_cat_add_desc("CH3",
        "cvars that control behavior of ch3");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpid/ch4/netmod/ofi/ofi_init.c */
    MPIR_T_cat_add_desc("CH4_OFI",
        "A category for CH4 OFI netmod variables");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpid/ch4/netmod/ucx/ucx_init.c */
    MPIR_T_cat_add_desc("CH4_UCX",
        "A category for CH4 UCX netmod variables");

    /* declared in /home/users/ea01/ea0103/work/mpich-tofu/mpich-exp/maint/../src/mpid/ch4/src/ch4_init.c */
...
int utf_MPI_hook(MPI_Comm comm, uint32_t *addr_tab, uint32_t *count)
{
    MPIR_Comm *comp = NULL;
    MPIDI_av_entry_t	*av;
    MPIR_Group	*grp;
    ...
    MPIR_Comm_get_ptr(comm, comp);
    if (comp->local_comm) {
	printf("[%d] comp->local_comm->node_count(%d)\n", comp->rank, comp->local_comm->node_count); fflush(stdout);
    }
    for(dst = 0; dst < comp->local_size && dst < cnt; dst++) { /* NOTE: local_size is an integer value */
	av = MPIDIU_comm_rank_to_av(comp, dst);
	if (av) {
	    // printf("[%d]\t MPIDI_OFI_AV(av).dest[0][0] = %ld\n", comp->rank, MPIDI_OFI_AV(av).dest[0][0]); fflush(stdout);
	    addr_tab[dst] = MPIDI_OFI_AV(av).dest[0][0];
	}
    }
    if (dst != cnt) {
	*count = dst;
