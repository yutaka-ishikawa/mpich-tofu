...
#define MPICH_THREAD_GRANULARITY MPICH_THREAD_GRANULARITY__SINGLE
...
#define MPIDI_CH4U_USE_PER_COMM_QUEUE 1

/* CH4 Directly transfers data through the chosen netmode */
#define MPIDI_CH4_DIRECT_NETMOD 1
...
/* Define to use tofu capability set */
#define MPIDI_CH4_OFI_USE_SET_TOFU 1
...
#define MPIR_COUNT_MAX LONG_MAX
...
#define MPIR_OFFSET_MAX LONG_MAX
...
#define MPIR_Ucount unsigned long
...
#define PACKAGE_STRING "MPICH 3.4b1"
